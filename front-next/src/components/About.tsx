    ...
    >
      <div className="h-screen flex flex-col md:flex-row relative text-center max-w-7xl justify-evenly px-5 mx-auto items-center">
        ...
        <motion.img
          ...
          className="-mb-20 md:mb-0 mt-32 flex-shrink-0 object-cover w-64 h-96 rounded-full md:rounded-lg md:w-64 md:h-96 xl:w-[400px] xl:h-[600px]"
          src={urlFor(pageInfo.profilePic).url()}
        />
        <div className="px-0 md:px-5  space-y-10">
